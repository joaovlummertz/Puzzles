...
export default function Episode({ episode }: { episode: EpisodeType | null }) {
    ...
    return (
		<section className="max-w-[1200px] min-h-[400px] flex mx-auto my-8">
			<div className="font-poppins w-full h-full pb-4 mx-6 rounded-sm bg-dark-yellow m-auto flex flex-col flex-grow">
